...
let result = calculator("47", 2, multiply)
// console.log(result)
...
applyDiscountByCategory(catProducts, 2, applyFlatRateDiscount, 2.5)
...
const formalGreeting = names => {
    ...
    let greetingNames = formalNames.map(name => {
        return "Hello, " + name
    })
...
const placestThatStartsWith = places.filter(place => place.startsWith("A"))
